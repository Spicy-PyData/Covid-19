...
app.layout= html.Div([
                        ...
                        html.Hr(),
                        # Bubble Charts Start Here

                        html.Div([
                                    html.Div(
                                        dcc.RadioItems(id='choose-category',
                                        options=[{'label':df.columns[2], 'value': df.columns[2]},
                                                    {'label':df.columns[3], 'value':df.columns[3]},
                                                    {'label':df.columns[4], 'value':df.columns[4]}
                                                    ],value=df.columns[2],
                                    labelStyle={'display': 'inline-block'}
                                                                            )),

                        html.Div([dcc.Graph(id='bubble-graph'),
